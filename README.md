...
Hierbij werd onder andere de log2-fold change (log2FC) en de adjusted p-value (padj) berekend, om de genen met significante expressieveranderingen tussen RA en de controlegroep eruit te halen.
Vervolgens werd een Gene Ontology (GO) verrijkingsanalyse uitgevoerd met goseq (Young et al., 2010) en visualisatie met ggplot2. Daarnast werden KEGG-pathways onderzocht met behulp van pathview. Resultaten werden weergegeven in o.a. een volcano plot (via EnhancedVolcano, met handleiding van Blighe et al., (2025)).
